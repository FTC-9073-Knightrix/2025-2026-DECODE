...
//                .strafeToLinearHeading(new Vector2d(54, 16), Math.toRadians(160))
//
//                .splineToLinearHeading(new Pose2d(58, 52, Math.toRadians(85)), Math.toRadians(90))
//                .splineToConstantHeading(new Vector2d(60, 54), 0)
//                .setTangent(0)
//                .splineToConstantHeading(new Vector2d(62, 50), Math.toRadians(270))
//                .splineToConstantHeading(new Vector2d(60, 48), Math.toRadians(180))
