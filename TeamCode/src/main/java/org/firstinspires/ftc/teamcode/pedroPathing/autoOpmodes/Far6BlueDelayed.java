...
@Autonomous(name = "Far 6 Blue Delayed", group = "Pedro Autonomous")
@Configurable // Panels
public class Far6BlueDelayed extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            DriveToFirstTape = follower
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(180 - 66), Math.toRadians(180 - 0), 0.3)
                    .build();
            ...
            DriveToCorner = follower
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(180 - 66), Math.toRadians(180 - 0), 0.4)
                    .addPath(
                            new BezierCurve(
