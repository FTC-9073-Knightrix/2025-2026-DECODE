...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1424.3944156334935; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3200.9746283987943; // x position of the perpendicular encoder (in tick units)
