...
@Autonomous(name = "Pedro Close 12 Red Double Open Gate", group = "Pedro Autonomous")
@Configurable // Panels
public class Close12RedDoubleOpenGate extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            OpenTheGate = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(128.000, 83.428),
                                    new Pose(119.363, 79.257),
                                    new Pose(110.960, 72.191),
                                    new Pose(127.340, 75.0)
                            )
                    )
            ...
            DriveBackFromGate = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(127.340, 75), new Pose(89.389, 83.149))
                    )
            ...
            DriveBackFromGate2 = follower
                    ...
                    .addPath(
                            new BezierLine(
                                    new Pose(127.767, 69.899), // drive back from the gate instead
            ...
            OpenTheGate2 = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(135.000, 59.400),
                                    new Pose(111.801, 57.837),
                                    new Pose(127.767, 69.899)
                            )
                    )
